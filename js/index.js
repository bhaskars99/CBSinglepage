(function () {
	...
	TSlider.prototype = {
		...
		/*
			...
			2) Apareceu? Come̤ou contagem.
			3) Acabou contagem, transiciona.
			4) Acabou transi̤̣o? Aparece novo slide.
		...
		*/
		...
		_startSlider: function() {
			...
			console.log('Come̤a contagem do slide ' + this.current + '.');
			...
			function animateCurrNavItem (el) {
				...
				TweenMax.to(el.querySelector('.li__info-mask'), self.sldInterval/1000, {
					...
					onComplete: function () {
						console.log('Agora, aciona as transi̵̤es.');
						slidesTransitions();
					}
				});
			...
			function slidesTransitions () {
				...
				var tm = new TimelineMax({ 
					onComplete: function () {
						...
						console.log('Transi̤̣o de slides terminado.');
